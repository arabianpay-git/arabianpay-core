...
<div class="email-wrapper">
    <div class="email-content" role="article" aria-roledescription="email" aria-label="Account Approved Email">
        <div class="email-header">
            <img src="{{ asset('media/images/logo.png') }}" alt="ArabianPay Logo" />
        </div>
        <div class="email-body">
            <h1>Hello {{ $name ?? 'Valued Customer' }}, Welcome to ArabianPay!</h1>
            <p>Your account has been <strong>Approved</strong>. You can now access all features and start using our services.</p>
