                                ...
                                <tbody>
                                    @foreach ($brands as $brand)
                                        <tr>
                                            ...
                                            <td>
                                                @if ($brand->logo)
                                                    <img src="{{ asset($brand->logo) }}" alt="{{ $brand->name }}" class="w-10 h-10 object-contain border-7">
                                                @else
                                            ...
                                            <td>
                                                <div class="flex gap-1">
                                                    <a class="btn btn-sm btn-icon btn-clear btn-primary" href="{{ route('brands.edit', $brand->id) }}">
                                                        <i class="ki-filled ki-notepad-edit"> </i>
                                                    </a>
                                                    <a class="btn btn-sm btn-icon btn-clear btn-danger delete-btn" href="{{ route('brands.destroy', $brand->id) }}">
