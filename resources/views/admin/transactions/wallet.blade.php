                        ...
                        <div class="flex flex-wrap gap-2 lg:gap-5">
                            <div class="flex">
                                <label class="input input-sm">
                                    ...
                                    <input data-datatable-search="#wallet_history_table"
                                        placeholder="{{ translate('Search transactions') }}" type="text"
                                        value="" />
                                </label>
                            </div>
                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="whitespace-nowrap">
                                                        ...
                                                        {{ $wallet->order?->invoice_number ?? translate('—') }}
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    {{ ucwords(str_replace('_', ' ', translate($wallet->transaction_type))) }}
                                                </td>
                                                ...
                                                @else badge-secondary @endif">
                                                        {{ ucfirst(translate($wallet->status)) }}
                                                    </span>
                                                </td>

                                                <td class="whitespace-nowrap">
                                                    {{ $wallet->created_at ? $wallet->created_at->format(dateFormat()) : translate('N/A') }}
                                                </td>
