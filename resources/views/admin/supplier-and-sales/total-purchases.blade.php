            ...
            <div class="card card-grid min-w-full">
                ...
                <div class="card-body">
                    <div data-datatable="true" data-datatable-state-save="false" id="team_crew_table">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">
                                            <span class="sort">
                                                <span class="sort-label font-normal text-gray-700">Invoice Value</span>
                                                <span class="sort-icon"> </span>
                                            </span>
                                        </th>
                                ...
                                <tbody>
                                    @foreach ($summary as $index => $row)
                                        <tr>
                                            ...
                                            <td class="text-left">{{ $row['invoice_count'] }}</td>
                                            <td class="text-center">
                                                <span class="icon-saudi_riyal"></span> {{ number_format($row['invoice_value'], 2) }}
                                            </td>
                                            <td class="text-center">
                                                <span class="icon-saudi_riyal"></span> {{ number_format($row['tax_total'], 2) }}
                                            </td>
                                            <td class="text-center">
                                                <span class="icon-saudi_riyal"></span> {{ number_format($row['grand_total'], 2) }}
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
                        ...
                        <!-- Pagination Footer -->
                        @include('layouts.includes.table-pagination', ['paginator' => $summary])
                    </div>
                </div>
            </div>
        </div>
