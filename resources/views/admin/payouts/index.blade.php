                    ...
                    <div class="kt-card h-full">
                        ...
                        <div class="grid gap-3 mt-5 mr-5">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <span class="text-sm font-medium text-foreground ml-5">{{ number_format((float) $orders->where('general_status', 'cancelled')->sum('grand_total')/1000, 2) }}K</span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="border-b border-gray-200">
                <nav class="-mb-px flex gap-4" id="langTabs">
                    <button class="tab-btn active" data-tab="orders">
                        ...
                        Orders
                        @if($orders->count() > 0)
                        <span class="badge badge-sm badge-danger  ml-2">{{ $orders->where('general_status', 'processing')->count() }}</span>
                        @endif
                    </button>
                                    ...
                                    <table class="table table-auto table-border" data-datatable-table="true">
                                        ...
                                        <tbody id="orders-tbody">
                                            ...
                                            <tr class="order-row"
                                                ...
                                                <div class="font-semibold text-gray-900">{{ number_format((float) $item->grand_total, 2) }}</div>
                                            
                                                  <div class="text-xs text-success"> - {{ number_format((float) $item->commission_amount, 2) }} Commission</div>
                                    ...
                                    <table class="table table-auto table-border" data-datatable-table="true">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-left">
                                                    <span class="sort asc">
                                                        <span class="sort-label font-normal text-gray-700">Order ID</span>
                                                        <span class="sort-icon"> </span>
                                                    </span>
                                                </th>
                                                <th class="text-left">
                                                ...
                                                <th class="text-center">
                                                    <span class="sort">
                                                        <span class="sort-label font-normal text-gray-700">Created By</span>
                                                        <span class="sort-icon"> </span>
                                                    </span>
                                                </th>
                                                <th class="text-center">
                                        ...
                                        <tbody id="payouts-tbody">
                                            ...
                                            <tr class="payout-row"
                                                ...
                                                <td class="text-center">
                                                 <div class="font-semibold text-gray-900">{{ number_format((float) $payout->amount, 2) }}</div>
...
<script>
    ...
    document.addEventListener('click', function(e) {
        ...
        console.log('Payout data:', { orderId, amount, customerName, sellerName });
