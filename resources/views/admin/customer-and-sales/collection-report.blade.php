                            ...
                            <table class="table table-auto table-border" data-datatable-table="true">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">
                                            <span class="sort">
                                                <span class="sort-label font-normal text-gray-700">Payment Number</span>
                                            </span>
                                        </th>
                                        <th class="text-center">
                                            <span class="sort">
                                        ...
                                        <th class="text-center">
                                            <span class="sort">
                                                <span class="sort-label font-normal text-gray-700">Collected Amount</span>
                                            </span>
                                        </th>
                                        <th class="text-center">
                                            <span class="sort">
                                                <span class="sort-label font-normal text-gray-700">Invoice Number Collected</span>
                                            </span>
                                        </th>
                                        <th class="text-center">
                                            <span class="sort">
                                        ...
                                        <th class="text-center">
                                            <span class="sort">
                                                <span class="sort-label font-normal text-gray-700">Remaining Invoice Amount</span>
                                            </span>
                                        </th>
                                ...
                                <tbody>
                                    @foreach ($transactions as $index => $transaction)
                                        <tr>
                                            ...
                                            <td class="text-center">{{ $transaction->user->customer->tax_number ?? '-' }}</td>
