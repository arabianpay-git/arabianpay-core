                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">
                                                <span class="sort">
                                                    <span
                                                        class="sort-label font-normal text-gray-700">{{ translate('Number of Invoices') }}</span>
                                                </span>
                                            </th>
                                            <th class="text-center">
                                                <span class="sort">
                                                    <span
                                                        class="sort-label font-normal text-gray-700">{{ translate('From Invoice Number') }}</span>
                                                </span>
                                            </th>
                                            <th class="text-center">
                                                <span class="sort">
                                                    <span
                                                        class="sort-label font-normal text-gray-700">{{ translate('To Invoice Number') }}</span>
                                                </span>
                                            </th>
                                            <th class="text-center">
                                                <span class="sort">
                                            ...
                                            <th class="text-center">
                                                <span class="sort">
                                                    <span
                                                        class="sort-label font-normal text-gray-700">{{ translate('VAT Amount') }}</span>
                                                </span>
                                            </th>
                                            <th class="text-center">
                                                <span class="sort">
