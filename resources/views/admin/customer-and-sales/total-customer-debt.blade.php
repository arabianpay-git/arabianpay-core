                            ...
                            <table class="table table-auto table-border" data-datatable-table="true">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">
                                            <span class="sort">
                                                <span class="sort-label font-normal text-gray-700">Total Customer</span>
                                            </span>
                                        </th>
                                        <th class="text-center">
                                            <span class="sort">
                                        ...
                                        <th class="text-center">
                                            <span class="sort">
                                                <span class="sort-label font-normal text-gray-700">Total Sales</span>
                                            </span>
                                        </th>
                                        <th class="text-center">
                                            <span class="sort">
                                                <span class="sort-label font-normal text-gray-700">Total Receipts</span>
                                            </span>
                                        </th>
                                        <th class="text-center">
                                            <span class="sort">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-center">Total Customers</td>
