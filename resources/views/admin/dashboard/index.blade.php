        ...
        <div class="container-fixed">
            <div class="flex flex-wrap items-center lg:items-end justify-between gap-5 pb-7.5">
                ...
                <div class="flex items-center gap-2.5">
                    ...
                    <a class="btn btn-sm btn-outline btn-secondary" data-modal-toggle="#sensitive_approval_modal">
                        {{ translate('Request Sensitive Data Access') }}
                    </a>
                    @include('admin.dashboard.includes.data-approval-modal')
                    <div class="flex">
                                ...
                                <div class="flex items-center justify-between">
                                    <div>
                                        ...
                                        <div class="text-2xl font-bold">
                                            {{ $riskData['credit_utilization']['utilization_percent'] }}%
                                        </div>
                                    </div>
