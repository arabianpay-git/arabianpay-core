                        ...
                        <div class="card-body dash-card">
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <div class="text-2xl font-bold">{{ $riskData['credit_utilization']['utilization_percent'] }}%</div>
                                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    new ApexCharts(document.querySelector('#walletChart'), {
        ...
        series:[
            { name:'Overall Balance', data: @json($financialData['wallet_balances']->pluck('balance')) },
            { name:'User Payment', data: @json($financialData['wallet_balances']->pluck('user_payment')) },
            { name:'Loan Disbursment', data: @json($financialData['wallet_balances']->pluck('loan_disbursment')) },
            { name:'Seller Payment', data: @json($financialData['wallet_balances']->pluck('seller_payment')) }
        ],
