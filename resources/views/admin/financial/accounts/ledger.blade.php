                ...
                <table class="table table-auto table-border">
                    ...
                    <tbody>
                        <tr class="bg-gray-50">
                            ...
                            @if($openingBalance >0)
                            <td class="text-right font-medium"><span class="icon-saudi_riyal"></span>{{ $openingBalance }}</td>
                            @else
                        ...
                        <tr>
                            <td class="w-12">{{ $row->entry_date ? \Carbon\Carbon::parse($row->entry_date)->format('Y-m-d') : '-' }}</td>
                            <td>
                            ...
                            <!-- if value =0 then '-' -->
                            @if($row->debit > 0)
                            <td class="text-right"><span class="icon-saudi_riyal"></span>{{ $row->debit ? ($row->debit == 0 ? 0 : $row->debit) : ' ' }}</td>
                            @else
                            <td class="text-right"> </td>
                            @endif
                            @if($row->credit > 0)
                            <td class="text-right"><span class="icon-saudi_riyal"></span>{{ $row->credit ? ($row->credit == 0 ? 0 : $row->credit) : ' ' }}</td>
                            @else
                            <td class="text-right"> </td>
                            @endif
