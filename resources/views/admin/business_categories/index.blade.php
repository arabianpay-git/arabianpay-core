            ...
            <div class="card card-grid min-w-full">
                ...
                <div class="card-body">
                    <div data-datatable="true" data-datatable-city-save="false" id="team_crew_table">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="flex gap-1">
                                                    <a class="btn btn-sm btn-icon btn-clear btn-primary" href="{{ route('business-categories.edit', $item->id) }}">
                                                        <i class="ki-filled ki-notepad-edit"> </i>
                                                    </a>
                                                    <a class="btn btn-sm btn-icon btn-clear btn-danger delete-btn" href="{{ route('business-categories.destroy', $item->id) }}">
                        ...
                        <!-- Pagination Footer -->
                        @include('layouts.includes.table-pagination', ['paginator' => $businessCategories])
                    </div>
                </div>
            </div>
        </div>
