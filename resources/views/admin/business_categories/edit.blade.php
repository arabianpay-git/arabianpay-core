                ...
                <div class="flex flex-col items-stretch grow gap-5 lg:gap-7.5">
                    <div class="card pb-2.5">
                        <div class="card-header" id="basic_settings">
                            <h3 class="card-title">{{ translate('Edit Business Category') }}</h3>
                        </div>
                            ...
                            <div class="p-5">
                                ...
                                <div class="tab-content" id="tab-en">
                                    <div class="grid gap-5">
                                        ...
                                        <div class="w-full">
                                            <label class="form-label">{{ translate('Business Category') }}</label>
                                        ...
                                        <div class="w-full">
                                            ...
                                            <input class="input @error('risk') border-red-500 @enderror" name="risk"
                                                type="text" value="{{ old('risk', $businessCategory->risk ?? '') }}"
                                                required />
                                            @error('risk')
                                                <span class="text-danger text-sm">{{ $message }}</span>
                                            @enderror
                                            <small class="text-gray">Hint: (1–5; 1 = very low risk, 5 = very high
                                                risk)</small>
                                        </div>
                                ...
                                <div class="tab-content hidden" id="tab-ar">
                                    <div class="grid gap-5">
                                        <div class="w-full">
                                            <label class="form-label">{{ translate('Business Category (Arabic)') }}</label>
