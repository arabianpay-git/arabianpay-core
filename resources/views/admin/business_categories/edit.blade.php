    ...
    <div class="container-fixed">
        <div class="flex grow gap-5 lg:gap-7.5">
            ...
            @endif
                    ...
                    <!-- Update Form -->
                    <form action="{{ route('business-categories.update', $businessCategories->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                                ...
                                <div class="grid gap-5">
                                    ...
                                    <div class="w-full">
                                        ...
                                        <input class="input @error('name.en') border-red-500 @enderror"
                                               name="name[en]"
                                               type="text"
                                               value="{{ old('name.en', $businessCategories->name ?? '') }}"
                                               required />
                                        @error('name.en')
                                    ...
                                    <div class="w-full">
                                        ...
                                        <select class="input @error('featured') border-red-500 @enderror" name="featured">
                                            <option value="true" {{ old('featured', $businessCategories->featured) == true ? 'selected' : '' }}>Yes</option>
                                            <option value="false" {{ old('featured', $businessCategories->featured) == false ? 'selected' : '' }}>No</option>
                                        </select>
                                        @error('featured')
                                            <span class="text-danger text-sm">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="w-full">
                                        ...
                                        <input class="input @error('order_level') border-red-500 @enderror"
                                               name="order_level"
                                               type="number"
                                               value="{{ old('order_level', $businessCategories->order_level) }}" />
                                        @error('order_level')
                                            <span class="text-danger text-sm">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    @include('media.single', [
                                        ...
                                        'required' => false,
                                        'value' => old('icon', $businessCategories->icon)
                                    ])
                                    ...
                                    @include('media.single', [
                                        ...
                                        'required' => false,
                                        'value' => old('banner', $businessCategories->banner)
                                    ])
                                </div>
                            </div>
                                ...
                                <div class="grid gap-5">
                                    <div class="w-full">
                                        ...
                                        <input class="input @error('name.ar') border-red-500 @enderror"
                                               name="name[ar]"
                                               type="text"
                                               value="{{ old('name.ar', $businessCategories->translations->where('locale', 'ar')->first()->name ?? '') }}" />
                                        @error('name.ar')
                                            <span class="text-danger text-sm">{{ $message }}</span>
                                        @enderror
                                    </div>
