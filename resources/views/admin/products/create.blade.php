    ...
    <form action="{{ route('products.store') }}" method="POST">
        ...
        <div class="container-fixed">
                                ...
                                <div class="card-body grid gap-5">
                                    ...
                                    <div class="w-full">
                                        <div class="flex items-baseline flex-wrap gap-2.5">
                                            ...
                                            <input class="input @error('unit') border-red-500 @enderror" name="unit" type="text" value="{{ old('unit') }}" placeholder="Unit (eg. KG, PC etc)" />
                                        </div>
                                        @error('unit')
                                        <span class="text-danger text-sm">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="w-full">
                                        <div class="flex items-baseline flex-wrap gap-2.5">
                                            ...
                                            <input class="input @error('weight') border-red-500 @enderror" name="weight" type="number" value="{{ old('weight', 0.00) }}" step="0.01" placeholder="0.00" />
                                        </div>
                                        @error('weight')
                                        <span class="text-danger text-sm">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="w-full">
                                        <div class="flex items-baseline flex-wrap gap-2.5">
                                            ...
                                            <input class="input @error('min_qty') border-red-500 @enderror" name="min_qty" type="number" value="{{ old('min_qty', 1) }}"  placeholder="1" />
                                        </div>
                                        @error('min_qty')
                                        <span class="text-danger text-sm">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="w-full">
                                        ...
                                        <span class="text-xs">This is used for search. Input those words by which customer can find this product.</span>
                                        @error('tags')
                                            <span class="text-danger text-sm">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="flex items-center flex-wrap gap-2.5">
                                        ...
                                        <div class="grow">
                                            <label class="switch">
                                                ...
                                                <input name="refundable" type="checkbox" value="1" {{ old('refundable') ? 'checked' : '' }} />
                                            </label>
                                        </div>
                                    </div>    
                                </div>
                                ...
                                <div class="card-body grid gap-5">
                                    <div class="w-full">
                                        <div class="flex flex-col gap-2.5">
                                            ...
                                            <select id="attribute_id" class="input @error('attribute_id') border-red-500 @enderror w-full" name="attribute_id[]" multiple>
                                ...
                                <div class="card-body grid gap-5">
                                    <div class="flex gap-2">
                                        <div class="w-full">
                                            <div class="flex items-baseline flex-wrap gap-2.5">
                                                ...
                                                <input class="input @error('unit_price') border-red-500 @enderror" name="unit_price" type="number" value="{{ old('unit_price', 0) }}" required />
                                            </div>
                                            @error('unit_price')
                                            <span class="text-danger text-sm">{{ $message }}</span>
                                            @enderror
                                        ...
                                        <div class="w-full">
                                            <div class="flex items-baseline flex-wrap gap-2.5">
                                                ...
                                                <input class="input @error('purchase_price') border-red-500 @enderror" name="purchase_price" type="number" value="{{ old('purchase_price', 0) }}" required />
                                            </div>
                                    ...
                                    <div class="flex gap-2">
                                        <div class="w-full">
                                            <div class="flex items-baseline flex-wrap gap-2.5">
                                                ...
                                                <input class="input @error('discount_start_date') border-red-500 @enderror" name="discount_start_date" placeholder="Discount Start Date" type="date" value="{{ old('discount_start_date') }}" required />
                                            </div>
                                        ...
                                        <div class="w-full">
                                            <div class="flex items-baseline flex-wrap gap-2.5">
                                                ...
                                                <input class="input @error('discount_end_date') border-red-500 @enderror" name="discount_end_date" placeholder="Discount End Date" type="date" value="{{ old('discount_end_date') }}" required />
                                            </div>
                                    ...
                                    <div class="flex gap-2">
                                        <div class="w-full">
                                            <div class="flex items-baseline flex-wrap gap-2.5">
                                                ...
                                                <input class="input @error('discount') border-red-500 @enderror" name="discount" type="number" value="{{ old('discount') }}" required />
                                            </div>
                                            @error('discount')
                                            <span class="text-danger text-sm">{{ $message }}</span>
                                            @enderror
                                        ...
                                        <div class="w-full">
                                            <div class="flex items-baseline flex-wrap gap-2.5">
                                                ...
                                                <select class="input @error('discount_type') border-red-500 @enderror" name="discount_type">
                                                    ...
                                                    <option value="amount" {{ old('discount_type') == 'amount' ? 'selected' : '' }}>Flat</option>
                                    ...
                                    <div class="w-full">
                                        <div class="flex items-baseline flex-wrap gap-2.5">
                                            ...
                                            <input class="input @error('current_stock') border-red-500 @enderror" name="current_stock" type="number" value="{{ old('current_stock') }}" required />
                                        </div>
                                        @error('current_stock')
                                        <span class="text-danger text-sm">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="w-full">
                                        <div class="flex items-baseline flex-wrap gap-2.5">
                                            ...
                                            <input class="input @error('sku') border-red-500 @enderror" name="sku" type="text" value="{{ old('sku') }}" />
                                        </div>
                                        @error('sku')
                                        <span class="text-danger text-sm">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="flex items-center flex-wrap gap-2.5">
                                        <div class="grow">
                                            <label class="switch justify-between">
                                                ...
                                                <input id="free_shipping" name="shipping_type" type="checkbox" value="free" {{ $oldShippingType === 'free' ? 'checked' : '' }} />
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex items-center flex-wrap gap-2.5">
                                        <div class="grow">
                                            <label class="switch justify-between">
                                                ...
                                                <input id="flat_rate" name="shipping_type" type="checkbox" value="flat_rate" {{ $oldShippingType === 'flat_rate' ? 'checked' : '' }} />
                                            </label>
                                        </div>
                                    </div>
                                
                                    <!-- Flat Rate Input Field (toggle visibility) -->
                                    <div id="flat_rate_input" class="flex items-center gap-2.5 {{ $oldShippingType === 'flat_rate' ? '' : 'hidden' }}">
                                        <label for="flat_rate_amount" class="text-sm">Flat Rate Amount</label>
                                        <input id="flat_rate_amount" type="number" class="input @error('shipping_cost') border-red-500 @enderror" name="shipping_cost" placeholder="Enter amount" value="{{ old('shipping_cost') }}" />
                                    </div>
                                    ...
                                    <div class="flex items-center flex-wrap gap-2.5">
                                        <div class="grow">
                                            <label class="switch justify-between">
                                                ...
                                                <input id="quantity_multiply" name="shipping_type" type="checkbox" value="product_wise" {{ $oldShippingType === 'product_wise' ? 'checked' : '' }} />
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body grid gap-5">
                                    <div class="w-full">
                                        <div class="flex items-baseline flex-wrap gap-2.5">
                                            ...
                                            <input class="input @error('low_stock_quantity') border-red-500 @enderror" name="low_stock_quantity" type="number" value="{{ old('low_stock_quantity', 1) }}" />
                                        </div>
                                ...
                                <div class="card-body grid gap-5">
                                    ...
                                    <div class="w-full">
                                        <div class="flex items-baseline flex-wrap gap-2.5">
                                            ...
                                            <input class="input @error('est_shipping_days') border-red-500 @enderror" name="est_shipping_days" type="number" value="{{ old('est_shipping_days') }}" />
                                        </div>
                                ...
                                <div class="card-body grid gap-5">
                                    ...
                                    <div class="w-full">
                                        <div class="flex items-baseline flex-wrap gap-2.5">
                                            ...
                                            <input class="input @error('tax') border-red-500 @enderror" name="tax" type="number" value="{{ old('tax') }}" />
                                        </div>
                                        @error('tax')
                                        <span class="text-danger text-sm">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="w-full">
                                        <div class="flex items-baseline flex-wrap gap-2.5">
                                            ...
                                            <select class="input @error('tax_type') border-red-500 @enderror" name="tax_type">
                                                <option value="">Select One Option</option>
                                                <option value="amount" {{ old('tax_type') == 'amount' ? 'selected' : '' }}>Flat</option>
                                                <option value="percent" {{ old('tax_type') == 'percent' ? 'selected' : '' }}>Percent</option>
                                            </select>
                                        </div>
                                        @error('tax_type')
                                        <span class="text-danger text-sm">{{ $message }}</span>
            ...
            <div class="flex justify-end pt-2.5">
                <button type="submit" name="action" value="unpublish" class="btn btn-danger" style="margin-right: 7px">
                    Save & Unpublish
                </button>
