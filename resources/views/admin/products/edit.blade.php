@extends("layouts.base") @section("content")
    ...
    <main class="content grow pt-5" id="content" role="content">
        ...
        <div class="container-fixed">
            <div class="pb-7.5 flex flex-wrap items-center justify-between gap-5 lg:items-end">
        ...
        <form action="{{ route("products.update", $product->id) }}" method="POST">
            ...
            <div class="container-fixed">
                <div class="tab-content" id="tab-en">
                    @if ($errors->any())
                        <div class="lg:gap-7.5 grid gap-5">
                            <div class="card rounded-xl">
                                <div
                                    class="upgrade-bg flex grow flex-wrap items-center justify-between gap-2 bg-[length:660px_310px] bg-no-repeat p-5 [background-position:121%_41%] sm:flex-wrap rtl:[background-position:-30%_41%]">
                                    <div class="flex items-center gap-4">
                                        <div class="relative size-[50px] shrink-0">
                                            <svg class="stroke-brand-clarity fill-brand-light h-full w-full" fill="none"
                                            ...
                                            <div
                                                ...
                                                <i class="ki-filled ki-information-4 text-brand text-xl"> </i>
                                            </div>
                                        </div>
                                        <div class="flex flex-col gap-1.5">
                                            <div class="flex flex-wrap items-center gap-2.5">
                                                <a class="hover:text-primary-active text-base font-medium text-gray-900"
                                                    href="#">
                    ...
                    @endif
                    <!-- begin: grid -->
                    <div class="lg:gap-7.5 mt-5 grid grid-cols-1 gap-5 xl:grid-cols-3">
                        <div class="col-span-2">
                            <div class="lg:gap-7.5 grid gap-5">
                                        ...
                                        <div class="card-body grid gap-5">
                                            <div class="w-full">
                                                <div class="flex flex-wrap items-baseline gap-2.5">
                                                    <label class="form-label flex max-w-56 items-center gap-1">
                                                        {{ translate("Merchants") }}
                                                    </label>
                                ...
                                <div class="card min-w-full">
                                    ...
                                    <div class="card-table scrollable-x-auto pb-3">
                                        <div class="card-body grid grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-5">
                                            <div class="col-span-3 md:col-span-2 sm:col-span-1">
                                                <div class="flex items-baseline flex-wrap gap-2.5">
                                                    <label class="form-label flex items-center gap-1 max-w-56">
                                                        {{ translate('Product Name (AR)') }} <span class="text-danger">*</span>
                                                    </label>
                                                    <input class="input @error('name.ar') border-red-500 @enderror"
                                                        name="name[ar]" type="text"
                                                        value="{{ old("name.ar", $product->translations->where("locale", "ar")->first()->name ?? "") }}" />
                                                </div>
                                                @error('name.ar')
                                                    <span class="text-danger text-sm">{{ $message }}</span>
                                                @enderror
                                            ...
                                            <div class="col-span-3 md:col-span-2 sm:col-span-1">
                                                <div class="flex items-baseline flex-wrap gap-2.5">
                                                    <label class="form-label flex items-center gap-1 max-w-56">
                                                        {{ translate('Product Name (EN)') }} <span class="text-danger">*</span>
                                                    </label>
                                                    <input class="input @error('name.en') border-red-500 @enderror"
                                                        name="name[en]" type="text"
                                                        value="{{ old('name.en', $product->getRawValue('name')) }}" required />
                                                </div>
                                                @error('name.en')
                                                    <span class="text-danger text-sm">{{ $message }}</span>
                                                @enderror
                                            ...
                                            <div class="col-span-3 md:col-span-2 sm:col-span-1">
                                             ...
                                             <div class="col-span-3 md:col-span-2 sm:col-span-1">
                                                <div class="flex flex-col gap-2.5">
                                                    ...
                                                    <textarea class="textarea @error("description.en") border-red-500 @enderror" name="description[en]" rows="4">{{ old("description.en", $product->description ?? "") }}</textarea>
                                                </div>
                                            ...
                                            <div class="col-span-3 md:col-span-2 sm:col-span-1 grid grid-cols-1 md:grid-cols-2 sm:grid-cols-3 gap-5">
                                            {{-- Category --}}
                                            <div >
                                                <div class="flex flex-col gap-1.5">
                                            ...
                                            <div>
                                                <div class="flex flex-col gap-1.5">
                                                    <label class="form-label">{{ translate('Unit (AR)') }}</label>
                                                    <input type="text" name="unit[ar]" class="input" value="{{ old('unit.ar', $product->translations->where("locale", "ar")->first()->unit ?? "") }}">
                                                </div>
                                                @error('unit')
                                                    <span class="text-danger text-sm">{{ $message }}</span>
                                                @enderror
                                            ...
                                            <div>
                                                <div class="flex flex-col gap-1.5">
                                                    <label class="form-label">{{ translate('Unit (EN)') }}</label>
                                                    <input type="text" name="unit[en]" class="input" value="{{ old('unit.en', $product->getRawValue('unit')) }}">
                                                </div>
                                                @error('unit')
                                                    <span class="text-danger text-sm">{{ $message }}</span>
                                                @enderror
                                            ...
                                            {{-- Refundable (small / inline) --}}
                                            <div >
                                                <div class="flex items-center flex-wrap gap-2.5 h-full">
                                    ...
                                    <div class="card-table scrollable-x-auto pb-3">
                                        <div class="card-body grid gap-5">
                                            @include("media.single", [
                                                ...
                                                "value" => old(
                                                    "thumbnail",
                                                    supplierMedia($product->thumbnail) ?? null),
                                                "info" => translate(
                                ...
                                <div class="card min-w-full">
                                    ...
                                    <div class="card-body grid gap-5">
                                        <!-- Attribute Select -->
                                        <div>
                                            <label for="attribute_id" class="form-label mb-2 text-sm font-semibold">
                                        ...
                                        <div id="attribute-values-wrapper" class="grid hidden gap-4"></div>
                                        ...
                                        <template id="variation-template">
                                            <div
                                                class="variation-row grid grid-cols-1 gap-5 rounded-xl border bg-gray-50 p-4 md:grid-cols-4">
                                                <input type="hidden" name="__NAME__[attribute_id]" value="__ID__">
                                                <input type="hidden" name="__NAME__[attribute_value_id]"
                                                    value="__ATTRIBUTE_VALUE_ID__">
                                                <input type="hidden" name="__NAME__[value]" value="__VALUE__">

                                                <div>
                                                    <label
                                                        class="form-label mb-1 text-sm font-semibold">{{ translate("Selected") }}</label>
                                                    <input type="text" class="input w-full"
                                                        value="__ATTRIBUTE_VALUE__" readonly>
                                                </div>
                                                <div>
                                                    <label
                                                        class="form-label mb-1 text-sm font-semibold">{{ translate("Price") }}</label>
                                                ...
                                                <div>
                                                    <label
                                                        class="form-label mb-1 text-sm font-semibold">{{ translate("SKU") }}</label>
                                                ...
                                                <div class="w-full">
                                                    <div class="flex flex-wrap items-baseline gap-2.5">
                                                        ...
                                                        <input
                                                            ...
                                                            type="date"
                                                            value="{{ old("discount_start_date", $product->discount_start_date ? \Carbon\Carbon::parse($product->discount_start_date)->format(dateFormat()) : "") }}" />
                                                    </div>
                                                ...
                                                <div class="w-full">
                                                    <div class="flex flex-wrap items-baseline gap-2.5">
                                                        ...
                                                        <input
                                                            ...
                                                            type="date"
                                                            value="{{ old("discount_end_date", $product->discount_end_date ? \Carbon\Carbon::parse($product->discount_end_date)->format(dateFormat()) : "") }}" />
                                                    </div>
                                        ...
                                        <div class="card-body grid gap-5">
                                            <div class="w-full">
                                                <div class="flex items-center gap-2.5">
                                                    <div class="grow">
                                                        <label
                                                            class="mb-1 block text-sm">{{ translate("Published") }}</label>

                                                        <select
                                                            class="input @error("published") border-red-500 @enderror w-full"
                                                            name="published">
                                                            <option value="">{{ translate("Select One Option") }}
                                                            </option>
                                            ...
                                            <div class="mt-4 flex flex-wrap items-center gap-2.5">
                                                <div class="grow">
                                                    <label class="mb-1 block text-sm">{{ translate("Approval") }}</label>

                                                    <select
                                                        class="input @error("approved") border-red-500 @enderror w-full"
                                            ...
                                            <div id="rejectReasonWrapper" class="mt-3" style="display: none;">
                                                <label class="mb-1 block text-sm">{{ translate("Reject Reason") }} <span
                                                        class="text-danger">*</span></label>
                                                <input type="text" name="reason_reject"
                                                    value="{{ old("reason_reject", $product->reason_reject ?? "") }}"
                                                    class="input @error("reason_reject") border-red-500 @enderror w-full"
                                    ...
                                    <div class="card-table scrollable-x-auto pb-3">
                                        <div class="card-body grid gap-5">
                                            ...
                                            <div id="flat_rate_input"
                                                class="{{ $product->shipping_cost ?? "" }} flex items-center gap-2.5">
                                    ...
                                    <div class="card-body grid gap-5">
                                        ...
                                        <div class="mt-4 w-full">
                                            <div class="flex flex-col gap-1.5">
                                                ...
                                                <input id="tags_ar"
                                                    class="input @error("tags.ar") border-red-500 @enderror w-full"
...
@push("scripts")
    ...
    <script>
        ...
        function buildValueSelectors(attrs) {
            ...
            attrs.forEach(id => {
                const label = document.querySelector(`#attribute_id option[value="${id}"]`)?.dataset.name ||
                    `Attribute ${id}`;
                ...
                vals.forEach(v => {
                    ...
                    option.text = v.value;
                    option.dataset.color = v.color_code || '#FFFFFF';
                    const isSelected = existingVariations.some(variation => variation.value.includes(v
                        .value));
                        ...
                        return {
                            item: (classNames, data) => {
                                ...
                                <div class="${classNames.item} ${data.highlighted ? classNames.highlightedState : ''}" 
                                    ...
                                    style="display:flex;align-items:center;padding:2px 6px;border-radius:4px;cursor:pointer;">
                                    <span style="display:inline-block;width:14px;height:14px;background:${data.element.dataset.color};margin-right:6px;border:1px solid #ccc;border-radius:2px;"></span>
                                    ${data.label}
                                </div>
                            `);
                                }
                                return template(
                                    `<div class="${classNames.item}" style="padding:2px 6px;border-radius:4px;cursor:pointer;">${data.label}</div>`
                                );
                            },
                            choice: (classNames, data) => {
                                ...
                                <div class="${classNames.item} ${classNames.itemChoice} ${data.disabled ? classNames.itemDisabled : classNames.itemSelectable}" 
                                    ...
                                    style="display:flex;align-items:center;padding:6px 10px;border-radius:4px;cursor:pointer;"
                ...
                // Update variation row on select change
                select.addEventListener('change', () => renderVariations());
            });

            renderExistingVariations();
        }

        // Updated renderVariations to handle multiple selections per attribute
...
@push("scripts")
    <script>
        const transLoading = @json(translate("Loading..."));
        const transSelectUnit = @json(translate("Select Unit"));
        const transFailed = @json(translate("Failed to load"));
        ...
        document.getElementById('category_id').addEventListener('change', function() {
            ...
            unitSelect.innerHTML = `<option value="">${transLoading}</option>`;

            if (!categoryId) {
                unitSelect.innerHTML = `<option value="">${transSelectUnit}</option>`;
                return;
            }
            ...
            fetch(`{{ url("admin/get-category-units") }}/${categoryId}`)
                ...
                .catch(error => {
                    ...
                    unitSelect.innerHTML = `<option value="">${transFailed}</option>`;
                });
        });
