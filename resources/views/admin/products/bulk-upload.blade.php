                            ...
                            <form action="{{ route('products.bulk-upload') }}" method="POST" enctype="multipart/form-data"
                                ...
                                <div>
                                    ...
                                    <p class="mt-2 text-sm text-gray-500">
                                        {{ __('Only') }} <strong>.csv</strong>
                                        {{ __('files are allowed. Max file size:') }}
                                        <strong>2 MB</strong>.
                                    </p>
                                    @error('file')
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="px-4 py-3 text-sm font-medium text-gray-800">category_name <span
                                                    class="text-danger">*</span></td>
                                            <td class="px-4 py-3 text-sm text-gray-700">
                                                {{ __('Must match an existing Category’s') }} <code>name</code>
                                                {{ __('in the database.') }}<br>
                                        ...
                                        <tr>
                                            <td class="px-4 py-3 text-sm font-medium text-gray-800">brand_name<span
                                                    class="text-danger">*</span></td>
                                            <td class="px-4 py-3 text-sm text-gray-700">
                                                {{ __('Must match an existing Brand’s') }} <code>name</code>
                                                {{ __('in the database (optional).') }}<br>
