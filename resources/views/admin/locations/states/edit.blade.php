                        ...
                        <div class="p-5">
                            ...
                            <div class="tab-content" id="tab-en">
                                <div class="grid gap-5">
                                    <!-- Name (EN) -->
                                    <div class="w-full">    
                                        <label class="form-label">State Name (English)</label>
                                        <input class="input @error('name.en') border-red-500 @enderror"
                                               name="name[en]"
                                               type="text"
                                               value="{{ old('name.en', $state->name) }}"
                                               required />
                                        @error('name.en')
                            ...
                            <div class="tab-content hidden" id="tab-ar">
                                <div class="grid gap-5">
                                    <!-- Name (AR) -->
                                    <div class="w-full">
                                        <label class="form-label">State Name (Arabic)</label>
                            ...
                            <div class="w-full mt-5">
                                ...
                                <select name="country_id" class="input @error('country_id') border-red-500 @enderror" required>
