                            ...
                            <div class="card-body grid gap-5">
                                ...
                                <div class="flex gap-4">
                                    ...
                                    <div class="w-full">
                                        <div class="flex items-baseline flex-wrap gap-2.5">
                                            <label class="form-label flex items-center gap-1 max-w-56">
                                                {{ translate('Min Score') }} <span class="text-danger">*</span>
                                            </label>
                                            <input class="input @error('min_score') border-red-500 @enderror"
                                                name="min_score" type="number" value="{{ old('min_score') }}" required />
                                        </div>
                                        @error('min_score')
                                            <span class="text-danger text-sm">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="w-full">
                                        <div class="flex items-baseline flex-wrap gap-2.5">
                                            <label class="form-label flex items-center gap-1 max-w-56">
                                                {{ translate('Max Score') }} <span class="text-danger">*</span>
                                            </label>
                                            <input class="input @error('max_score') border-red-500 @enderror"
                                                name="max_score" type="number" value="{{ old('max_score') }}" required />
                                        </div>
                                        @error('max_score')
                                            <span class="text-danger text-sm">{{ $message }}</span>
                                        @enderror
