    ...
    <div class="container-fixed">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-5 lg:gap-7.5">
                    ...
                    <div class="card-body p-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5">
                            <div class="flex flex-col">
                                <span class="text-sm opacity-80">Total Entitlement</span>
                            ...
                            <div class="flex flex-col">
                                <span class="text-sm opacity-80">Total Paid</span>
                                <span class="text-xl font-bold">
                                    <span class="icon-saudi_riyal"></span>
                            ...
                            <div class="flex flex-col">
                                <span class="text-sm opacity-80">Pending Payment</span>
                                <span class="text-xl font-bold">
                                    <span class="icon-saudi_riyal"></span>
                            ...
                            <div class="flex flex-col">
                                <span class="text-sm opacity-80">Total Commission</span>
                                <span class="text-xl font-bold">
                                    <span class="icon-saudi_riyal"></span>
                            ...
                            <div class="flex flex-col">
                                <span class="text-sm opacity-80">Total Products in Stock</span>
                                <span class="text-xl font-bold">{{ $stockCount ?? 0 }}</span>
                            </div>
                        
                            <div class="flex flex-col">
                                <span class="text-sm opacity-80">Average Product Rating</span>
                                <span class="text-xl font-bold">{{ number_format($avgRating ?? 0, 1) }} / 5</span>
                            </div>
                        
                            <div class="flex flex-col">
                                <span class="text-sm opacity-80">Account Status</span>
                                <span class="text-xl font-bold">
                            ...
                            <div class="flex flex-col">
                                <span class="text-sm opacity-80">Last Payment Date</span>
                                <span class="text-xl font-bold">
                                    {{ $lastPaymentDate 
                                        ? \Carbon\Carbon::parse($lastPaymentDate)->format('d M Y H:m:s') 
                                        : '-' }}</span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-span-1">
                <div class="card bg-gradient-to-r from-green-600 via-emerald-600 to-teal-600 text-white shadow-lg rounded-2xl">
                    <div class="card-body p-6">
                        <h3 class="text-lg font-semibold mb-4">Supplier Financial Stats</h3>
            
                        <div class="flex flex-col gap-5">
                            <div class="w-full">
                                <span class="text-sm opacity-80">Total Orders Supplied</span>
                                <span class="text-xl font-bold">{{ number_format($totalOrders ?? 0) }}</span>
                            </div>
                        
                            <div class="w-full">
                                <span class="text-sm opacity-80">Total Products Supplied</span>
                                <span class="text-xl font-bold">{{ number_format($totalProducts ?? 0) }}</span>
                            </div>
                        
                            <div class="w-full">
                                <span class="text-sm opacity-80">Average Delivery Time</span>
                                <span class="text-xl font-bold">
                                    {{ $avgDeliveryTime !== null 
                                        ? number_format($avgDeliveryTime, 1) . ' days'
                                        : '-' }}
                                </span>
                            </div>
                        
                            <div class="w-full">
                                <span class="text-sm opacity-80">Total Returned Orders</span>
                                <span class="text-xl font-bold">{{ number_format($totalReturns ?? 0) }}</span>
                            </div>
                        
                            <div class="w-full">
                                <span class="text-sm opacity-80">Total Cancelled Orders</span>
                                <span class="text-xl font-bold">{{ number_format($totalCancelled ?? 0) }}</span>
                            </div>
                        
                            <div class="w-full">
                                <span class="text-sm opacity-80">Last Supplied Order Date</span>
                                <span class="text-xl font-bold">
                                    {{ $lastOrderDate 
        ...
        <div class="modal-body p-0 pb-5">
            <form action="{{ route('customerUpgradeLimit') }}" method="POST" class="px-5 pt-3">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="limit_arabianpay_before" name="limit_arabianpay_before" class="input" value="{{ old('limit_arabianpay_before', $merchant->limit_arabianpay_after ?? '') }}" required>
                </div>

                <div class="mb-4">
                    <label class="form-label" for="limit_arabianpay_after">Limit Arabianpay After</label>
                    <input type="text" id="limit_arabianpay_after" name="limit_arabianpay_after" class="input" value="{{ old('limit_arabianpay_after', $merchant->limit_arabianpay_after ?? '') }}" required>
                </div>

                <div class="mb-4">
                    <label class="form-label">Commission</label>
                    <input type="text" name="comission" class="input" value="{{ old('comission', $merchant->comission ?? '') }}" required>
                </div>
        ...
        <div class="modal-body p-0 pb-5">
            <form action="{{ route('createCreditLimit') }}" method="POST" class="px-5 pt-3">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="limit_arabianpay_before" class="input" value="{{ old('limit_arabianpay_before', $merchant->limit_arabianpay_after ?? '') }}" required>
                </div>

                <div class="mb-4">
                    <label class="form-label">Limit Arabianpay After</label>
                    <input type="text" name="limit_arabianpay_after" class="input" value="{{ old('limit_arabianpay_after', $merchant->limit_arabianpay_after ?? '') }}" required>
                </div>
