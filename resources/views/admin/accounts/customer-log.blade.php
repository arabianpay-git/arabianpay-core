                ...
                <div class="card grow" id="activity_2024">
                    <div class="card-header">
                        <h3 class="card-title">
                            ...
                            <span class="text-muted text-sm">({{ $logs->total() }} {{ translate('records') }})</span>
                        </h3>
                    </div>
                    <div class="card-body">
                                    ...
                                    <div class="ps-2.5 mb-7 text-md grow">
                                        <div class="flex flex-col">
                                            ...
                                            <span class="text-xs text-gray-600">
                                                {{ $log->created_at->diffForHumans() }} [{{ $log->created_at }}] -
                                                {{ $log->causer->first_name ?? 'System' }}
                                            </span>
                                            ...
                                            <div id="details-{{ $log->id }}"
                                                ...
                                                @if ($log->properties)
                                                    @foreach ($log->properties->toArray() as $key => $value)
                                                        <div
                                                            class="flex justify-between text-xs text-gray-700 border-b py-1">
