                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="whitespace-nowrap text-sm">
                                                    <div>
                                                        <span>Amount:</span> {{ number_format($item->order->grand_total, 2) }} SAR
                                                    </div>
                                                    <div>
                                                        <span>City:</span> <small class="text-xs text-gray-500">{{ $item->order->shipping_city ?? '—' }}</small>
                                                    </div>
                                                    <div>
                                                        <span>Status:</span> 
                                            ...
                                            <td class="whitespace-nowrap">
                                                @if($item->loan_start_date && $item->loan_end_date)
                                                    <div>
                                                        <strong>Start Date:</strong> {{ \Carbon\Carbon::parse($item->loan_start_date)->format('d M Y') }}
                                                    </div>
                                                    <div>
                                                        <strong>End Date:</strong> {{ \Carbon\Carbon::parse($item->loan_end_date)->format('d M Y') }}
                                                    </div>
                                                @else
                                                    N/A
                                                @endif
                                            ...
                                            <td class="text-center">
                                                @php
                                                    ...
                                                    $badgeColor = $statusColors[$item->payment_status] ?? 'bg-gray-400';
                                                @endphp
                                            ...
                                            <td class="text-center">
                                                @php
                                                    ...
                                                    $settlementBadgeColor = $settlementStatusColors[$item->settlement_status] ?? 'bg-gray-400';
                                                @endphp
