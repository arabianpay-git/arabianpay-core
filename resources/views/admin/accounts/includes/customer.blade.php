    ...
    <div class="flex flex-col items-center gap-2 lg:gap-3.5 py-4 lg:pt-5 lg:pb-10">
        ...
        <div class="flex flex-wrap justify-center gap-1 lg:gap-4.5 text-sm">
            ...
            <div class="flex gap-1.25 items-center">
                ...
                <a class="text-gray-600 font-medium hover:text-primary" href="tel: {{ $customer->user->phone_number }}">
            ...
            <div class="flex gap-1.25 items-center">
                ...
                <a class="text-gray-600 font-medium hover:text-primary" href="mailto: {{ $customer->user->email }}">
                    {{ $customer->user->email }}
                </a>
            </div>
        </div>
    ...
    <div class="flex items-start justify-between gap-4 py-4 lg:py-6">
        ...
        <div class="flex items-center gap-4">
            <div class="flex items-center justify-center rounded-full border-2 border-success-clarity shrink-0 bg-light">
                @php
                    $shopLogo = \App\Models\ShopSetting::where('user_id', $customer->user_id)->first();
                    ...
                    } elseif (!empty($customer->user->profile_photo_path)) {
                        $logoPath = 'https://partners.arabianpay.net/storage/' . $customer->user->profile_photo_path;
                    } else {
            ...
            <div class="flex flex-col">
                <div class="flex items-center gap-1.5">
                    <div class="text-xl leading-6 font-bold text-gray-900">
                        {{ $customer->user?->business_name ?? 'N/A' }}
                    </div>
                    @php
                ...
                <div class="flex flex-wrap items-center justify-start gap-3 text-sm pt-4 contact-info-list">
                    ...
                    <div class="flex gap-1.25 items-center separator">
                        <i class="ki-filled ki-phone text-gray-500 text-sm"> </i>
                        <a class="underline link" href="tel: {{ $customer->user->phone_number }}">
                            {{ $customer->user->phone_number }}
                        </a>
                    </div>
                    ...
                    <div class="flex gap-1.25 items-center separator">
                        <i class="ki-filled ki-sms text-gray-500 text-sm"> </i>
                        <a class="underline link" href="mailto: {{ $customer->user->email }}">
                            {{ $customer->user->email }}
                        </a>
                    </div>
                    ...
                    <div class="flex gap-1.25 items-center separator">
                        ...
                        {{ $customer->user->created_at->format(dateFormat()) }}
                    </div>
                </div>
            </div>
        </div>
