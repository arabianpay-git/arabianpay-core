                        ...
                        <form action="{{ route('risk-register.store') }}" method="POST">
                            ...
                            <div class="card-body grid gap-5">
                                ...
                                <div class="flex gap-4">
                                    ...
                                    <div class="w-full">
                                        ...
                                        <select name="status" id="status" class="select w-full" required>
                                            <option value="low" {{ old('status') == 'low' ? 'selected' : '' }}>Low
                                            </option>
                                            <option value="medium" {{ old('status') == 'medium' ? 'selected' : '' }}>Medium
                                            </option>
                                            <option value="high" {{ old('status') == 'high' ? 'selected' : '' }}>High
                                            </option>
                                ...
                                <div class="flex justify-end pt-2.5">
                                    <button type="submit" class="btn btn-primary">Save Risk Register</button>
                                </div>
                            </div>
                        </form>
                    </div>
