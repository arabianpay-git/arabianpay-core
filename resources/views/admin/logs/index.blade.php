                        ...
                        <form method="GET" action="{{ route('activity-logs.index') }}" class="flex">
                            <label class="input input-sm">
                                ...
                                <input name="search" type="text"
                                    placeholder="{{ __('Search by employee, action, module') }}"
           ...
           <div class="flex items-center gap-4">
            ...
            <div class="grid grid-col gap-1">
             <a class="text-base font-medium text-gray-900 hover:text-primary-active mb-px" href="#">
              [{{ $log->event }}] <span class="text-2sm text-gray-600">{{ $log->created_at->diffForHumans() }} [{{$log->created_at}}] - {{ $log->causer->first_name ?? 'System' }}</span>
             </a>
