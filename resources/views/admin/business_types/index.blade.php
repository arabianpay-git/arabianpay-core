                                ...
                                <tbody>
                                    @foreach ($businessTypes as $item)
                                        <tr>
                                            ...
                                            <td>
                                                @if ($item->icon)
                                                    <img src="{{ asset($item->icon) }}" alt="{{ $item->name }}" class="w-10 h-10 object-contain border-7">
                                                @else
                                            ...
                                            <td>
                                                <div class="flex gap-1">
                                                    <a class="btn btn-sm btn-icon btn-clear btn-primary" href="{{ route('business-types.edit', $item->id) }}">
                                                        <i class="ki-filled ki-notepad-edit"> </i>
                                                    </a>
                                                    <a class="btn btn-sm btn-icon btn-clear btn-danger delete-btn" href="{{ route('business-types.destroy', $item->id) }}">
