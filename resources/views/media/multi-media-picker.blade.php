    ...
    <div class="container py-5">
        ...
        <div class="form-group">
            ...
            <div class="input-group">
                <input type="text" id="multiMediaInput" class="form-control" placeholder="Click to select media"
                    readonly>
            ...
            $('#fileInput').on('change', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.success && response.media.length > 0) {
                            response.media.forEach(media => {
                                const isSelected = selectedMedia.find(item => item.id ==
                                    media.id) ? 'selected' : '';
                    ...
                    `);
                            ...
                            Swal.fire('Uploaded!', 'All files uploaded successfully.',
                                'success');
                        } else {
                        ...
                        success: function(response) {
                            if (response.media.length > 0) {
                                ...
                                response.media.forEach(item => {
                                    const isSelected = selectedMedia.find(m => m.id ===
                                        item.id) ? 'selected' : '';
