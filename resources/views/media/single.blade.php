...
<div class="w-full">
    <div class="flex items-baseline flex-wrap gap-2.5">
        ...
        <div class="flex items-center w-full max-w-md relative">
            ...
            <input type="text" id="{{ $inputId }}_display" class="input w-full @error($inputName) border-red-500 @enderror" placeholder="Click to select media" readonly value="{{ basename($inputValue) }}" data-modal-toggle="#{{ $inputId }}_modal" style="padding-inline-start: 2.75rem;" >
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response.success) {
                        ...
                        Swal.fire('Uploaded!', response.message || 'File uploaded successfully.', 'success');
                    } else {
