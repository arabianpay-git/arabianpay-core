<div>
    @if (Gate::check('addTeamMember', $team))
        ...
        <div class="mt-10 sm:mt-0">
            <x-form-section submit="addTeamMember">
                <x-slot name="title">
                    {{ translate('Add Team Member') }}
                </x-slot>

                <x-slot name="description">
                    {{ translate('Add a new team member to your team, allowing them to collaborate with you.') }}
                </x-slot>

                <x-slot name="form">
                    <div class="col-span-6">
                        <div class="max-w-xl text-sm text-gray-600">
                            {{ translate('Please provide the email address of the person you would like to add to this team.') }}
                        </div>
                    </div>
                    ...
                    @if (count($this->roles) > 0)
                        <div class="col-span-6 lg:col-span-4">
                            <x-label for="role" value="{{ translate('Role') }}" />
    ...
    @if ($team->teamInvitations->isNotEmpty() && Gate::check('addTeamMember', $team))
        ...
        <div class="mt-10 sm:mt-0">
            <x-action-section>
                <x-slot name="title">
                    {{ translate('Pending Team Invitations') }}
                </x-slot>

                <x-slot name="description">
                    {{ translate('These people have been invited to your team and have been sent an invitation email. They may join the team by accepting the email invitation.') }}
                </x-slot>
    ...
    @if ($team->users->isNotEmpty())
        ...
        <div class="mt-10 sm:mt-0">
            <x-action-section>
                ...
                <x-slot name="description">
                    {{ translate('All of the people that are part of this team.') }}
                </x-slot>
    ...
    <x-confirmation-modal wire:model.live="confirmingLeavingTeam">
        ...
        <x-slot name="content">
            {{ translate('Are you sure you would like to leave this team?') }}
        </x-slot>
    ...
    <x-confirmation-modal wire:model.live="confirmingTeamMemberRemoval">
        ...
        <x-slot name="content">
            {{ translate('Are you sure you would like to remove this person from the team?') }}
        </x-slot>
